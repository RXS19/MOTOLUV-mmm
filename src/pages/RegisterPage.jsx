  ...
  const submit = async (e) => {
    ...
    try {
      const u = await register({
        ...
        city: form.city, password: form.password, role,
      });
      toast({ title: '¡Cuenta creada!', description: `Bienvenido a Motoluv, ${u.name.split(' ')[0]}.` });
    ...
    <div className="max-w-6xl mx-auto px-5 lg:px-8 py-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        ...
        <form onSubmit={submit} className="bg-[#111112] border border-white/5 rounded-md p-6 md:p-8">
          <h2 className="font-display font-bold text-white text-2xl uppercase mb-6">Crear cuenta</h2>
